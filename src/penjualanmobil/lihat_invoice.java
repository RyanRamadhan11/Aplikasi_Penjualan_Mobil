 ...
 */
public class lihat_invoice extends javax.swing.JFrame {
private Connection con; 
private Statement stat; 
private ResultSet res; 
    public lihat_invoice() {
        initComponents();
...
DefaultTableModel t= new DefaultTableModel(); 
 ...
 JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(240, 30, 120, 28);
 ...
 dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lihat_invoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lihat_invoice().setVisible(true);
            }
        });
    }
